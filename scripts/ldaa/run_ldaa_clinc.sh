...
do
    ...
    do
        ...
        do 
            ...
            --seed $seed \
            --config_file_name "./methods/${method}/configs/config_${dataset}_ldaa_finetune.yaml" \
            --save_results \
            ...
            --result_dir "./${prefix}/${method}/results_retry_ds_r1_3level_${dataset}_${suffix}_kcr${known_cls_ratio}" \
